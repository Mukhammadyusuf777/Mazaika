...
const niche_synthesizer_1 = require("./niche-synthesizer");
const offline_patch_1 = require("./offline-patch");
...
Bot Edges: ${JSON.stringify(currentBotEdges.slice(0, 20))}`;
                ...
                if (!patchApplied || finalHtml === existingHtml) {
                    ...
                    const offlineResult = (0, offline_patch_1.applySemanticOfflinePatch)(existingHtml, promptText, isRu);
                ...
                const isRu = isRawRussian(promptText);
                const richFallback = (0, niche_synthesizer_1.generateComprehensiveProject)(promptText, target || 'bot_and_mini_app', isRu);
    ...
    generateRichFallbackProject(promptText, target, isRu) {
        return (0, niche_synthesizer_1.generateComprehensiveProject)(promptText, (target === 'site_only' ? 'site_only' : 'bot_and_mini_app'), isRu);
    }
};
