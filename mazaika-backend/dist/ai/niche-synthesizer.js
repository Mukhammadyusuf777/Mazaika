...
exports.detectNiche = detectNiche;
exports.getNicheConfig = getNicheConfig;
exports.generateComprehensiveProject = generateComprehensiveProject;
function detectNiche(promptText) {
...
function getNicheConfig(niche, isRu) {
    switch (niche) {
        case 'clinic':
            return {
                nicheKey: 'clinic',
...
function generateComprehensiveProject(promptText, target, isRu) {
...
//# sourceMappingURL=niche-synthesizer.js.map