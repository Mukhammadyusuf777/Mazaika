  ...
  "project_data": {
    ...
    "bot_edges": [{"id":"e1","source":"node_1","target":"node_2"}]
      ...
      if (googleKey) {
        ...
        // Check if result is empty or invalid (e.g. no html/files and no bot_blocks)
        ...
        // 🔧 SELF-HEALING: retry with lower temperature (0.3 instead of 0.7) if first AI call returns an empty or invalid result
